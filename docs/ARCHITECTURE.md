...
Если любой канал схлопнулся при фильтре риска, reducer переключает фильтр на
все незакрытые; выбранная карточка сохраняется, если её канал видим в списке.
...
если энергии канала не хватит даже на один переход. Закрытие портала, для
