...
export function GameSetup({ onStart, storageWarning }: {
  ...
  return <main className={styles.setup}>
    ...
    <ol>
      <li>За 10 минут исследуйте 9 миров. Новые порталы появляются случайно; одновременно место занимают не более 8 незакрытых каналов, включая схлопнувшиеся.</li>
      ...
      <li>Верните сотрудников вручную. Через критичный портал возврат возможен, если хватает энергии; при нехватке верните часть группы или выберите другой канал.</li>
      ...
      <li>Закрывайте ненужные порталы, освобождая место для новых. Схлопнувшийся канал закрывается вручную. Последний маршрут в неисследованный мир и канал к сотрудникам закрываются только после предупреждения.</li>
